...
public class Week4CodingAssignment {
	...
	//13.Create a method of your own that solves a problem. In comments, write what the method does and why
			//you created it.
	//The method I created is a boolean expression of when I go to bed. If it's 9 o'clock or later, I will go to bed, but
	//it it's earlier then I will stay awake.
	
	public static boolean bedTime (int time) {
		if(time >= 9) {
			return true;
		} else {
			return false;
